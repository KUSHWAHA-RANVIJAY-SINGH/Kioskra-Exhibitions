    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        @media (max-height: 500px) {
          ...
          .mobile-landscape-widget .tooltip-text {
            display: none !important;
          }
        }
      `}} />
      <div className={`fixed bottom-6 right-6 z-50 flex flex-col gap-3.5 items-end transition-all duration-300 mobile-landscape-widget ${
        !isScrolled ? "opacity-0 pointer-events-none sm:opacity-100 sm:pointer-events-auto" : "opacity-100 pointer-events-auto"
      }`}>
        {/* Phone Call Button */}
        ...
        <div className="relative flex items-center">
          ...
          <a
            ...
            className="bg-[#25D366] text-white hover:bg-[#20bd5a] w-12 h-12 rounded-full shadow-2xl transition-transform duration-200 hover:scale-110 flex items-center justify-center cursor-pointer relative"
